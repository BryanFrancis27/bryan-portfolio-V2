...
export const timelineEvents: TimelineEvent[] = [
  {
    ...
    description:
      "Bachelor of Science in Information Technology, major in Software Engineering. Expected graduation: 2028.",
  ...
  {
    period: "2024-2025",
    title: "Professional Web Application Base",
  ...
  {
    period: "Current",
    title: "Full Stack Product Direction",
